        ...
        'pages'               => array( 
          array(
           ...
           // 'parent_slug'     => apply_filters( 'ot_theme_options_parent_slug', 'themes.php' ),
            'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'Argo Options', 'option-tree' ) ),
            'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'Argo Options', 'option-tree' ) ),
            ...
            'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'Argo Options updated.', 'option-tree' ) ),
            'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'Argo Options reset.', 'option-tree' ) ),
