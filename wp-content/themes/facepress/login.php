...
<?php if(_core::method("_settings","logic","settings","general","theme","enb-login")){
		...
		<?php }elseif( isset( $_GET['action'] ) && $_GET['action'] == "recover" ){ ?>
			<div class="login">
				<form name="lostpasswordform" id="lostpasswordform" action="<?php echo home_url();?>/wp-login.php?action=lostpassword" method="post" class="form txt" target="registration_iframe">
					<fieldset>
						<p>
