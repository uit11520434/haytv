<?php
    class document{
        ...
        public static function head( $type = 'browser', $btype = 'Mozilla' ){
        ...
        public static function type( $type , $btype = 'Mozilla' ){
            switch( $type ){
                case 'browser' : {
        ...
        public static function style( ){
            ...
            ?><link href='http://fonts.googleapis.com/css?family=Ropa+Sans&amp;subset=latin,latin-ext' rel='stylesheet' type='text/css'><?php
            if( is_singular() ){
                global $post;
