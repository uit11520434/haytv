<?php
    class post_settings{
        public static function useSocial( $postID ){
        ...
        public static function useSource( $postID ){
        ...
        public static function useTags( $postID ){
            $result = false; 
        ...
        public static function useCategory( $postID ){
            $result = false; 
        ...
        public static function getTags( $resource , $postID ){
            $result = array();
        ...
        public static function useAttachdocs( $postID ){
            $result = false;
        ...
        public static function useAuthorBox( $postID ){
            $resources = _core::method( '_resources' , 'get' );
            $customID = _attachment::getCustomIDByPostID( $postID );
        ...
        public static function useRelated( $postID ){
        ...
        public static function isEmptyMeta( $postID ){
        ...
        public static function useMeta( $postID ){
        ...
        public static function useGrid( $template ){
