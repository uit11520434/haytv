<?php
	class _text{
		static function preview(  $page , $tab , $group , $prefix , $text ){
		...
		static function fields( $page , $tab , $group , $prefix , $link , $classes = '' , $text = 'Test text for preview' , $default = array( 'Francois One' , 24 , 'normal' ) , $hover = array() ){
        ...
        static function border_right( $page , $tab , $group , $prefix ){
        ...
        static function border_bottom( $page , $tab , $group , $prefix ){
        ...
        static function border_left( $page , $tab , $group , $prefix ){
