<?php
    class _panel{
		...
		static function header( $page = null , $current_tab = null ){
        ...
        static function tabber( $page , $tab , $current_group ){
            $result = '';
        ...
        static function path( $slug ){
            $path = 'admin.php?page=' . $slug;
            return $path;
        }

        static function page_class( $slug , $current ){
        ...
        static function page( $title , $page , $tab , $group , $description = '' , $update = true ){
?>
...
<?php
        ...
        static function fields( $page , $tab ,  $group ){
            $result = '';
